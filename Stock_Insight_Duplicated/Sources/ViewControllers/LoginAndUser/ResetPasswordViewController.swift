...
extension ResetPasswordViewController: UITextFieldDelegate{
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {//사용자가 텍스트 필드의 편집을 완료하고 텍스트 필드가 편집 모드에서 벗어났을 때 호출
        ...
        self.resetPasswordButton.isEnabled = !isPasswordEmpty && !isRepasswordEmpty && !isUserNameEmpty && !isQuizEmpty && !isAnswerEmpty
...
extension ResetPasswordViewController: UIPickerViewDelegate, UIPickerViewDataSource{
